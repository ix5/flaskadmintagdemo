    ...
    var AdminForm = function() {
      ...
      */
      this.applyStyle = function($el, name) {
        ...
        switch (name) {
            // Ignore select2 class, we'll style the tags separately and then
            // style all remaining select elements at once
            // -> select2, select2-tags elements will be ignored for now
